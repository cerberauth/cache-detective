...
`--aggressive` also gates [stale-if-error confirmation](../checks/stale-serving/#stale-if-error) — since confirming it means asking the origin to simulate a failure.
